...
<svg xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 614 383.76" class="w-full">
	<defs>
		<style>
			.cls-1 {
				isolation: isolate;
		...
		<linearGradient id="linear-gradient-10" x1="89.92" y1="448.19" x2="226.82" y2="254.6" gradientUnits="userSpaceOnUse">
			<stop offset="0" stop-color={$currentThemeStore === 'dark' ? 'var(--color-dark-950)' : 'var(--color-primary-950)'} />
	...
	<g id="OBJECTS">
		...
		<circle
			class="cls-moon-light hidden dark:block"
			cx="353.5"
			cy="241.44"
			r="179"
			transform="translate(-135.18 262.55) rotate(-45)"
		/>
		<path
