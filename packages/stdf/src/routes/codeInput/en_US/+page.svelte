<script lang="ts">
	...
	// Input finish callback
	const handleFinish1 = (val: string) => {
		console.log('Code input finished:', val);
	};

	const handleFinish6 = (val: string) => {
		if (val !== '123456') {
			errorInfo6 = 'Invalid code, please try again';
		} else {
			errorInfo6 = '';
		}
	};
...
<div class="p-4 space-y-6">
	<p class="text-sm text-gray-500">Basic Usage</p>
	...
	<p class="text-sm text-gray-500">Custom Length</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value2}
	...
	<p class="text-sm text-gray-500">Masked</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value3}
	...
	<p class="text-sm text-gray-500">Custom Mask</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value3b}
	...
	<p class="text-sm text-gray-500">Letter Input</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value4}
	...
	<p class="text-sm text-gray-500">No Gutter</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value5}
	...
	<p class="text-sm text-gray-500">FullKeyboard Preview</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value9}
	...
	<p class="text-sm text-gray-500">Custom Font</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value10}
	...
	<p class="text-sm text-gray-500">Line Mode</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value11}
	...
	<p class="text-sm text-gray-500">Underline Cursor</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value12}
	...
	<p class="text-sm text-gray-500">Pulse Animation</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value13}
	...
	<p class="text-sm text-gray-500">Custom Radius</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value14}
	...
	<p class="text-sm text-gray-500">Theme Background</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value15}
	...
	<p class="text-sm text-gray-500">Dashed Border</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value16}
	...
	<p class="text-sm text-gray-500">No Border + Surface Background</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value17}
	...
	<p class="text-sm text-gray-500">Bold</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value17b}
	...
	<p class="text-sm text-gray-500">Auto Close</p>
	<div class="flex justify-center">
		<CodeInput
			bind:value={value18}
	...
	<Toast bind:visible={showToast18} message="Input complete, keyboard closed" />
