## 0.5.5 <font size=1>2025-04-27</font>

- Optimized Input component, please see [Input](https://0.stdf.design/#/components?nav=input&tab=4).

## 0.5.3 <font size=1>2024-11-19</font>

- Optimized Icon component, please see [Icon](https://0.stdf.design/#/components?nav=icon&tab=4).

## 0.5.2 <font size=1>2024-10-02</font>

- Optimized Button component, please see [Button](https://0.stdf.design/#/components?nav=button&tab=4).

## 0.5.1 <font size=1>2024-10-02</font>

- Optimized Button component, please see [Button](https://0.stdf.design/#/components?nav=button&tab=4).
- Optimized BottomSheet component, please see [BottomSheet](https://0.stdf.design/#/components?nav=bottomSheet&tab=4).
- Optimized IndexBar component, please see [IndexBar](https://0.stdf.design/#/components?nav=indexBar&tab=4).
- Fixed Avatar component, please see [Avatar](https://0.stdf.design/#/components?nav=avatar&tab=4).

## 0.5.0 <font size=1>2024-09-09</font>

- Added Stepper component, please see [Stepper](https://0.stdf.design/#/components?nav=stepper&tab=0).

## 0.4.7 <font size=1>2024-08-12</font>

- Fixed Pagination component, please see [Pagination](https://0.stdf.design/#/components?nav=pagination&tab=4).
- Optimized Loading component, please see [Loading](https://0.stdf.design/#/components?nav=loading&tab=4).
- Optimized Slider component, please see [Slider](https://0.stdf.design/#/components?nav=slider&tab=4).

## 0.4.6 <font size=1>2024-03-31</font>

- Add Loading type, For more information, please see [Loading](https://0.stdf.design/#/components?nav=loading&tab=4).

## 0.4.5 <font size=1>2024-03-28</font>

- Fixed the Pagination component, please see [Pagination](https://0.stdf.design/#/components?nav=pagination&tab=4).

## 0.4.4 <font size=1>2023-12-13</font>

- Enhanced Tabs components, please see [Tabs](https://0.stdf.design/#/components?nav=tabs&tab=4).

## 0.4.3 <font size=1>2023-12-11</font>

- Modify the Tabs component, please see [Tabs](https://0.stdf.design/#/components?nav=tabs&tab=4).
...
- Added support for multi-theme configuration, please refer to [Theme Configuration](https://0.stdf.design/#/guide/theme), [Color](https://0.stdf.design/#/guide/color), [Theme Generator](https://0.stdf.design/#/guide/generator).
- In accordance with the Tailwind naming rules, the gray color has been uniformly changed from `gray5` to `gray-500` writing method. Please note that the writing method should be changed after the upgrade. See [Color](https://0.stdf.design/#/guide/color) for details.
- The Avatar component adds the usage of the avatar group, please see [Avatar](https://0.stdf.design/#/components/avatar&tab=4).

## 0.3.2 <font size=1>2023-10-11</font>

- Fix Input, please see [Input](https://0.stdf.design/#/components?nav=input&tab=4).

## 0.3.1 <font size=1>2023-10-11</font>

- Enhanced the Input component. For details, see [Input](https://0.stdf.design/#/components?nav=input&tab=4).

## 0.3.0 <font size=1>2023-09-20</font>

- Add NumKeyboard component, please see [NumKeyboard](https://0.stdf.design/#/components?nav=numKeyboard&tab=0).

## 0.2.11 <font size=1>2023-09-15</font>

- Fix Cell, please see [Cell](https://0.stdf.design/#/components?nav=cell&tab=4).
- Fix Icon, please see [Icon](https://0.stdf.design/#/components?nav=icon&tab=4).
- Fix Skeleton, please see [Skeleton](https://0.stdf.design/#/components?nav=skeleton&tab=4).

## 0.2.10 <font size=1>2023-09-11</font>

- Enhanced the Cell component. For details, see [Cell](https://0.stdf.design/#/components?nav=cell&tab=4).
...
- Reverted the language import path back to `stdf/lang/xx_XX`, as described in the [Internationalization](https://0.stdf.design/#/guide/internation) section.
...
- The default value of `path` in the Icon component has been modified. Please refer to the [Icon](https://0.stdf.design/#/components?nav=icon&tab=4) section for more details.
...
- Updated the language import path from `stdf/lang/xx_XX` to `stdf/dist/lang/xx_XX`. For more details, please refer to the [Internation](https://0.stdf.design/#/guide/internation).
...
- Enhanced the Swiper component. For details, see [Swiper](https://0.stdf.design/#/components?nav=swiper&tab=4).
...
- Pagination add Props. Please see [Pagination](https://0.stdf.design/#/components?nav=pagination&tab=4).

## 0.1.2 <font size=1>2023-07-11</font>

- Pagination fine-tuning. Please see [Pagination](https://0.stdf.design/#/components?nav=pagination&tab=4).
...
- Add Pagination component, please see [Pagination](https://0.stdf.design/#/components?nav=pagination&tab=0).
...
- Optimize Input, please see [Input](https://0.stdf.design/#/components?nav=input&tab=4).

## 0.0.10 <font size=1>2023-06-17</font>

- Optimize Cell, please see [Cell](https://0.stdf.design/#/components?nav=cell&tab=4).
...
- Fix Calendar, please see [Calendar](https://0.stdf.design/#/components?nav=calendar&tab=4).
